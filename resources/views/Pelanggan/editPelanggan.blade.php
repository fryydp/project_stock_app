                        ...
                        <div class="card-body">
                            <div class="mb-4 form-outline">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{ old('nama_pelanggan', $data->name_pelanggan) }}" name="nama_pelanggan" id="nama_pelanggan" class="form-control @error('nama_pelanggan') is-invalid @enderror" placeholder="Masukkan Nama Pelanggan..."/>
                            ...
                            <div class="mb-4 form-outline">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" value="{{ old('telp', $data->telp) }}" name="telp" id="telp" class="form-control @error('telp') is-invalid @enderror" placeholder="Masukkan Nomor Telepon Pelanggan..."/>
                                    @error('telp')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-4 form-outline">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="alamat" id="" cols="10" rows="3" class="form-control @error('alamat') is-invalid @enderror" placeholder="Masukkan Alamat Pelanggan...">{{ old('alamat', $data->alamat) }}</textarea>></textarea>
                                    @error('alamat')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-4 row">
                                <div class="col">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{ old('kota', $data->kota)}}" name="kota" id="kota" class="form-control @error('kota') is-invalid @enderror" placeholder="Masukkan Kota..."/>
                                        @error('kota')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col">
                                    ...
                                    <div class="input-group">
                                        <span class="text-white input-group-text bg-primary"><i class="bi bi-map"></i></span>
                                        <input type="text" value="{{ old('provinsi', $data->provinsi)}}" name="provinsi" id="provinsi" class="form-control @error('provinsi') is-invalid @enderror" placeholder="Masukkan Provinsi..."/>
                                        @error('provinsi')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
